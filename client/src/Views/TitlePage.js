...
const Title = () => {
    ...
    return(
            ...
            <div style={{width:"100%", backgroundColor:"black", height:1000, paddingTop:200, marginTop:-130}}>
                ...
                <Carousel.Item>
                    <img style={{height:400, width:500}}
            ...
            <div style={{width:500, marginLeft: 470, textAlign:"justify"}}>
                <p style={styles.p}>Welcome to <strong>Archi<span style={styles.span}>fy</span></strong>
                (Architecture <span style={styles.span}>F</span>or <span style={styles.span}>Y</span>ou)! A place to enjoy the world of architecture.
                Here you will find a collection of projects that not only span a wide range of styles, disciplines, and time periods, 
                but also the globe. Add your favorite projects and browse entries by others. To get started enter <span><Link to="/reglogin" style={styles.Link}>here</Link>.</span></p>
            </div>
        </div>
    )
}
